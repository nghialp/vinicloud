$(function ($) {
    ...
    var $testimonialSlider = $('.testimonial-slider');
        ...
        loop: true,
        navText: ['<i class="fi fi-br-angle-small-left"></i>', '<i class="fi fi-br-angle-small-right"></i>'],
        nav: true,
        dots:false,
        animateOut: 'fadeOut',
        animateIn: 'fadeIn',
    ...
    var $product_slider = $('.product-slider');
        ...
        loop: true,
        nav: true, navText: ['<i class="fi fi-br-angle-small-left"></i>', '<i class="fi fi-br-angle-small-right"></i>'],
        dots: false,
        margin:30,
        autoplay: false,
